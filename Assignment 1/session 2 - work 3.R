...
sav_data <- read_sav("D:/R programming runs/Assisgnments/Assignment 1/Manish Shah - SAQ8.sav")

get_table <- function(col_name){
  data_label <- attr(col_name, "label")
  data_values <- col_name
...
get_table(sav_data$q01)
get_table(sav_data$q03)
get_table(sav_data$q06)
get_table(sav_data$q08)
